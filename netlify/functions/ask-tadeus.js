// ARQUIVO: netlify/functions/ask-tadeus.js (VERSÃO 8.1 - LÓGICA DE CONFIANÇA REFINADA)
// ATUALIZAÇÃO 8.1:
// 1. CORREÇÃO DE PRECISÃO: Aumentada a prioridade da intenção 'greeting' para 100.
// 2. OBJETIVO DA CORREÇÃO: Garantir que saudações simples sejam respondidas instantaneamente pelo Cérebro Local,
//    eliminando o risco de respostas confusas da IA e economizando custos de API.
// 3. ESTRUTURA MANTIDA: Nenhuma outra lógica foi alterada.
...
// ========================================================================
// 2. CÉREBRO LOCAL (PLANO D) - v8.1: BASE DE CONHECIMENTO DE VENDAS
// ========================================================================
const tadeusLocalBrain = {
    intents: [
        ...
        // --- CONHECIMENTO DE VENDAS E OBJEÇÕES ---
...
exports.handler = async (event) => {
    ...
    let reply = "";
    console.log("Analisando com o Cérebro Local (v8.1)...");
